...
const LivePreview = ({ params }) => {
  ...
  return (
    ...
    >
      <div
        className="p-10 flex justify-center items-start h-fit w-screen"
      ...
      <div className="flex justify-start p-2">
        <Link
          ...
          // >
          className="flex gap-2 items-center px-3 py-1 cursor-pointer border border-black rounded-lg transition ease-in-out delay-150 hover:-translate-y-1 duration-300 hover:scale-110 "
        >
